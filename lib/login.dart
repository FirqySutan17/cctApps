                ...
                Container(
                    ...
                    child: Padding(
                        ...
                        child: Container(
                            // width: 44.0,
                            // height: 44.0,
                            child: Center(child: new Image.asset('assets/images/cct-logo.png', width:125.0, height:125.0)),
                        ),
                    ),
                ),
                // SizedBox(
                    ...
                    child: Padding(
                        ...
                        child: Center(
                            child: Column(
                                ...
                                children: [
                                    Text("LOGIN", style: TextStyle(fontSize: 30, fontFamily: 'Cjfont', fontWeight: FontWeight.bold)),
                                    Text("welcome to cct mobile apps", style: TextStyle(fontSize: 12, fontFamily: 'Cjfont')),
                                    SizedBox(
                                        height: 30,
                                    ),
                                    Container(
